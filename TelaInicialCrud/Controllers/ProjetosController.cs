...
namespace TelaInicialCrud.Controllers
{
    ...
    public class ProjetosController : Controller
    {
        ...
        public ProjetosController(TelaInicialCrudContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProjeto,NomeProjeto,Descricao,Valor,DataInicio,DataFim,QuantPessoas")] Projeto projeto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProjeto,NomeProjeto,Descricao,Valor,DataInicio,DataFim,QuantPessoas")] Projeto projeto)
        {
